...
from application.library.forms import EditBookForm, CreateBookForm
...
@library.route('/create/book/<pub_id>', methods=['GET', 'POST'])
@login_required
def create_book(pub_id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('library.display_publisher', publisher_id=pub_id))
